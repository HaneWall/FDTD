...
# Step 1: init grid
test = f.Grid(3000, 4e-09) # creates 201 grid cells (á 4.0e-09m)
...
#test[20:871] = f.LorentzMedium(name='Varin', permeability=1, eps_inf=1.05, chi_1=[2.42, 9.65, 1.46], chi_2=[30.e-12, 0, 0], chi_3=[0, 0, 0], conductivity=0, w0=[1.5494e16, 9.776e13, 7.9514e15], gamma=[0, 0, 0])
...
#test[20:31] = f.NonDispersiveMedia(name='randm', permeability=1, permittivity=1.4, conductivity=0)
#test[32:40] = f.NonDispersiveMedia(name='randm2', permeability=1, permittivity=1.2, conductivity=0)
...
test[10] = f.EnvelopeSinus(name='test', wavelength=1.064e-06, fwhm=14.6e-06, amplitude=2*2.74492e7, phase_shift=0, peak_timestep=13000, tfsf=True)
...
#test[10] = f.GaussianImpulse(name='test', amplitude=1, peak_timestep=12000, fwhm=20e-06, tfsf=True)
...
test[2972] = f.E_FFTObserver(name='E_two_lambda_laterpeak_13000_737', first_timestep=0, second_timestep=99995)
test[2966] = f.P_FFTObserver(name='P_two_lambda_laterpeak_13000_737', first_timestep=0, second_timestep=99995)
...
test.run_timesteps(timesteps=100000)
