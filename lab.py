...
test[20] = f.EnvelopeSinus(name='test', wavelength=60.0e-09, fwhm=200.e-09, amplitude=1, phase_shift=0, peak_timestep=300,tfsf=True)
#test[20] = f.GaussianImpulse(name='test', amplitude=1, peak_timestep=120, fwhm=130.e-09, tfsf=True)
