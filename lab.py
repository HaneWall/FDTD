...
# Step 1: init grid
test = f.Grid(301, 5e-07) # creates 201 grid cells (á 4.0e-09m)

# Step 2: init media
#test[50:180] = f.NonDispersiveMedia(name='Media4Epsleft', permeability=1, permittivity=2, conductivity=0)
#test[50:91] = f.LorentzMedium(name='Taflove', permeability=1, eps_inf=1.5, chi_1=5.1, conductivity=0, w0=1.2566e14, gamma=8e12)
test[100:271] = f.LorentzMedium(name='firsttest', permeability=1, eps_inf=4, gamma=5e12, w0=1e14, chi_1=2.1, conductivity=0)
...
#test[15] = f.ActivatedSinus(name='sin**2activation', wavelength=1.9e-05, carrier_wavelength=50e-05, phase_shift=0, amplitude=1, tfsf=True)
