...
setup_4 = f.Quasi_Phase_Matching(number_of_lambdas=2, timesteps=60000, courant=1, name='two_lambda_60000_courant_1_timestep_peak_16000_analyze_shg', peak_timestep=16000, mode='length')
