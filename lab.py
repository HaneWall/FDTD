...
#test[5] = f.ActivatedSinus(name='sin**2activation', wavelength=60e-07, carrier_wavelength=20*60e-07, phase_shift=0, amplitude=1, tfsf=True)
#test[15] = f.SinusoidalImpulse(name='test', amplitude=1, phase_shift=0, wavelength=1000, tfsf=True)
#test[15] = f.EnvelopeSinus(name='test', wavelength=50.0e-07, fwhm=100e-07, amplitude=1, phase_shift=0, peak_timestep=200, tfsf=True)
