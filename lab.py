...
setup_3 = f.Harmonic_Slab_Lorentz_Setup(dx=1/3 * 3.94e-07, length_grid_in_dx=50, length_media_in_dx=30, start_index_media=5, wavelength=1.75e-05, eps_inf=1.5, chi_1=5.1, conductivity=0, w0=1.2566e14, gamma=8e12, ampl=1, timesteps=4000)
