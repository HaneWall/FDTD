...
setup_3 = f.Harmonic_Slab_Lorentz_Setup(dx=3/6 * 3.91e-07, length_grid_in_dx=50, length_media_in_dx=30, start_index_media=5, wavelength=1.75e-05, eps_inf=1.0, chi_1=[2.1, 2.4], chi_2=[0, 0], chi_3=[0, 0], conductivity=0, w0=[1.2566e14, 1.2e13], gamma=[8e12, 9e14], ampl=1, timesteps=6000)
...
# Step 1: init grid
test = f.Grid(35, 4e-09) # creates 201 grid cells (á 4.0e-09m)
...
test[20:30] = f.LorentzMedium(name='Varin', permeability=1, eps_inf=1.00, chi_1=[2.42, 9.65, 1.46], chi_2=[30.e-12, 0, 0], chi_3=[0, 0, 0], conductivity=0, w0=[1.5494e16, 9.776e13, 7.9514e15], gamma=[0, 0, 0])
...
test[34] = f.RightSideMur()
    
# Step 6: run simulation
test.animate_timesteps(timesteps=32000)
